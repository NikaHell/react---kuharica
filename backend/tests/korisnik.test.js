...
describe('tests korisnici', () =>{
    ...
    test('Dohvacanje jednog korisnika', async () => {
        const korisnici = await pomocni.korisnikBaza()
    ...
    test('stvaranje novog korisnika', async () => {
        const pocetniKorisnici = await pomocni.korisnikBaza()
        ...
        const korisniciKraj= await pomocni.korisnikBaza()
    ...
    test('uspjesno mijenjanje korisnika', async () => {
        ...
        const korisniciPocetak = await pomocni.korisnikBaza()
        ...
        .expect(200)
        .expect('Content-Type', /application\/json/)
        const korisniciNaKraju = await pomocni.korisnikBaza()
